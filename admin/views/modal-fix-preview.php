...
$sub_edit_url     = isset( $sub_edit_url ) ? (string) $sub_edit_url : '';
...
$manual_only      = isset( $manual_only ) ? (bool) $manual_only : false;
...
$meta = $rule_meta[ $rule_id ] ?? $rule_meta['ghost_sub'];
?>
...
<div class="modal"
	...
	<div class="modal-head">
		<?php if ( ! empty( $sub_edit_url ) ) : ?>
			<a class="sub-id has-ext"
				href="<?php echo esc_url( $sub_edit_url ); ?>"
				target="_blank" rel="noopener noreferrer"
				title="<?php esc_attr_e( 'Open subscription in WooCommerce (new tab)', 'doctor-subs' ); ?>">
				<span class="num">#<?php echo esc_html( (string) $sub_id ); ?></span>
	...
	<div class="modal-foot">
		<?php if ( $manual_only ) : ?>
			<button type="button" class="btn btn-ghost" data-dr-subs-modal-cancel>
				<?php esc_html_e( 'Close', 'doctor-subs' ); ?>
			</button>
			<?php if ( ! empty( $sub_edit_url ) ) : ?>
				<a class="btn btn-primary"
					href="<?php echo esc_url( $sub_edit_url ); ?>"
					target="_blank" rel="noopener noreferrer">
					<?php esc_html_e( 'Open in WooCommerce', 'doctor-subs' ); ?>
				</a>
			<?php endif; ?>
		<?php else : ?>
			<button type="button" class="btn btn-ghost" data-dr-subs-modal-cancel>
